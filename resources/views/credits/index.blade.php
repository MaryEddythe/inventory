...
<script>
    ...
    function updateCreditTypeOptions() {
        ...
        // Re-render dropdown options from allowed credit types
    ...
    function updateCreditHoursVisibility() {
        ...
        // Only show hours input for CTO / hour-based credits
    ...
    // Ensure correct options when modal opens (in case an employee was previously selected)
    ...
    function openCreateCtoModal() {
        ...
        // Reset selection; will be preselected after employee is selected
