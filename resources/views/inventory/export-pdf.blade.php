...
<body>
        ...
        <table class="pdf-table pdf-table-striped">
            <thead>
                ...
                <tr>
                    ...
                    <th class="pdf-col-8">CO/MOOE</th>
                    <th class="pdf-col-8 pdf-text-center">Date Acquired</th>
                    <th class="pdf-col-10">Remarks</th>
                    <th class="pdf-col-6 pdf-text-center">Status</th>
                </tr>
            </thead>
            <tbody>
                ...
                <tr>
                    ...
                    <td class="pdf-text-right pdf-nowrap">PHP {{ number_format($item->unit_price, 2) }}</td>
                    <td>{{ $item->co_mooe }}</td>
    ...
    <div class="pdf-footer pdf-mt-2">
        <p>Page {PAGENO} of {nbpg} | Total Records: {{ $items->count() }} | Generated by Inventory Management System ni Idith</p>
    </div>
</body>
</html>