...
<div class="container-fluid py-3">
    <div class="d-flex flex-wrap justify-content-between align-items-center gap-3 mb-4">
        <div>
            <h2 class="mb-1">Sidebar Access</h2>
            <p class="text-muted mb-0">Assign sidebar items and roles per user.</p>
        </div>
    </div>

    @foreach($users as $user)
        @php($selectedIds = $user->sidebarItems->pluck('id')->all())
        <form class="card mb-4 shadow-sm" method="POST" action="{{ route('sidebar-access.update', $user) }}">
            @csrf
            @method('PUT')
                ...
                <div class="row g-3 align-items-start">
                    <div class="col-lg-4">
                        ...
                        <div class="form-text mt-2">
                            If you choose sidebar items below, they override the role default for this user.
                        </div>
                    </div>
